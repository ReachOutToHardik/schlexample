...
const Hero = () => {
  const images = [
    "https://images.unsplash.com/photo-1523050853063-bd42da24637d?auto=format&fit=crop&q=80&w=1920",
    "https://images.unsplash.com/photo-1509062522246-3755977927d7?auto=format&fit=crop&q=80&w=1920",
    "https://images.unsplash.com/photo-1511629091441-ee46146481b6?auto=format&fit=crop&q=80&w=1920",
     ...
     <div className="container mx-auto px-4 md:px-12">
        ...
        <div className="grid md:grid-cols-12 gap-8 h-auto lg:h-[700px]">
           <div className="md:col-span-8 bg-white shadow-xl p-12 relative overflow-hidden group border-t-4 border-school-accent">
              ...
              <img src="https://images.unsplash.com/photo-1581093588401-fbb62a02f120?auto=format&fit=crop&q=80&w=800" className="absolute top-0 right-0 h-full w-1/2 object-cover opacity-10 group-hover:opacity-30 transition-opacity" />
           </div>
  ...
  <div className="bg-slate-50">
     <div className="container mx-auto px-12 py-32">
        ...
        <div className="mt-32 p-20 bg-school-primary text-white relative overflow-hidden">
           <div className="absolute inset-0 bg-white/5 grayscale" style={{ backgroundImage: 'radial-gradient(circle, #fff 1px, transparent 1px)', backgroundSize: '40px 40px' }} />
          ...
          <section className="py-32 bg-slate-50 container mx-auto px-4 md:px-12 text-center" id="gallery">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
               {[
                 ...
                 "https://images.unsplash.com/photo-1523050853063-bd42da24637d?auto=format&fit=crop&q=80&w=600"
               ].map((img, i) => (
